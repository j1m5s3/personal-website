    ...
    return (
        <div>
            <div className="site-text">
                <h2 className="mt-5"> What I'm Working on Now... </h2>
                ...
                <p>
                    ...
                    are in use. This project doesn't seek to necessarily solve any problems but more so a fun and simple concept that I'm looking to build out further 
                ...
                <p>
                    The application is hosted on <mark>AWS via the lightsail service</mark>. For the purpose of this project I'm hosting the frontend application on an EC2
